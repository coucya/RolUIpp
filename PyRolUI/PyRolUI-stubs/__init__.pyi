...
class Widget:
    ...
    def set_child(self, child: Widget, index: int = 0) -> Widget: ...
    def remove_child(self, index: int = 0): ...
...
class SingleChildWidget(Widget):
    def child_count(self) -> int: ...
    def child(self, index: int = 0) -> Widget: ...
    def set_child(self, child: Widget, index: int = 0) -> SingleChildWidget: ...
    def remove_child(self, index: int = 0): ...
...
class MultiChildWidget(Widget):
    ...
    def set_child(self, child: Widget, index: int) -> MultiChildWidget: ...
    def insert_child(self, index: int, child: Widget) -> MultiChildWidget: ...
    @overload
