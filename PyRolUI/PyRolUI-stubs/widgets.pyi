...
def vscroll_view(*, child: Widget, step: float) -> VScrollView: ...
def hscroll_view(*, child: Widget, step: float) -> HScrollView: ...
...
def pointer_listener(*, child: Widget) -> PointerListener: ...
def mouse_listener(*, child: Widget) -> MouseListener: ...
def focus_listener(*, child: Widget) -> FocusListener: ...
def char_input_listener(*, child: Widget) -> CharImputListener: ...
