...
namespace RolUIBackend {
    ...
    class GLFWPainter : public RolUI::IPainter {
      ...
      public:
        ...
        virtual void draw_roundedrect(int32_t x, int32_t y, uint32_t w, uint32_t h, uint32_t round) override;
        ...
        virtual void draw_circle(int32_t x, int32_t y, uint32_t r) override;
        ...
        virtual void fill_roundedrect(int32_t x, int32_t y, uint32_t w, uint32_t h, uint32_t round) override;
        ...
        virtual void fill_circle(int32_t x, int32_t y, uint32_t r) override;
